...
PATH_FOLDER_WIP = os.path.join(PATH_ROOT,FOLDER_WIP)
PATH_FOLDER_EXPORTS = os.path.join(PATH_FOLDER_WIP, FOLDER_EXPORT)
PATH_FOLDER_IMPORT = os.path.join(PATH_FOLDER_WIP, FOLDER_IMPORT)
PATH_FOLDER_DUMP = os.path.join(PATH_FOLDER_WIP, FOLDER_DUMP)
PATH_FOLDER_LOGS = os.path.join(PATH_FOLDER_WIP, FOLDER_LOGS)
PATH_FOLDER_NNETS = os.path.join(PATH_FOLDER_WIP, FOLDER_NNETS)

PATH_FOLDER_EXPORTS_NN = os.path.join(PATH_FOLDER_EXPORTS, 'nn')

CONFIG_KEY_SUBMISSION = 'submission'
