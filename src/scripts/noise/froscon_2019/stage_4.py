# SCOPE - let's build a p value gradient
# RESULT - with a bit of fine tuning we get a nice gradient
...
N = 1
NUM_SEGMENTS = len(PS)
SEGMENT_LENGTH = WIDTH // NUM_SEGMENTS
...
for current_iteration in range(N):
    ...
    def generate_full_image(color_string,seed):
        ...
        for i in range(NUM_SEGMENTS):
            ...
            image[:,start:end] =  r.binomial_from(rkey,1,PS[i],size=(HEIGHT,SEGMENT_LENGTH))
